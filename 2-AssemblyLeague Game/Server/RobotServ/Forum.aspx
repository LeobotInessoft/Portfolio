<%@ Page Title="" Language="C#" MasterPageFile="~/Clear.Master" AutoEventWireup="true" CodeBehind="Forum.aspx.cs" Inherits="RobotServ.Forum" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="ButtonNew" runat="server" Text="START NEW THREAD" onclick="ButtonNew_Click" 
         />
         <h1>Forum</h1>
