...
public class FollowCam : MonoBehaviour {
  //  public GameObject player;
    ...
    public static FollowCam PublicAccess;
	...
	void FixedUpdate () {
        if (GameObjectFollower.PublicAccess!= null && GameObjectFollower.PublicAccess.GameObjectToFollow != null)
        {
    ...
    private void FocusCameraOnNextSelected()
    {
        if (gameObject != null && GameObjectFollower.PublicAccess.GameObjectToFollow != null)
        {
...

            {
                ...
                gameObject.transform.LookAt(GameObjectFollower.PublicAccess.GameObjectToFollow.transform.position);
            }
            if (IsFocussed)
            {
                gameObject.transform.LookAt(GameObjectFollower.PublicAccess.GameObjectToFollow.transform.position + GameObjectFollower.PublicAccess.GameObjectToFollow.transform.forward * Setting_ExtraForwardDistance + GameObjectFollower.PublicAccess.GameObjectToFollow.transform.up * Setting_ExtraUpwardDistance);
